angular.module('myApp.hero-card', ['ngRoute'])
  ...
  .controller('HeroCtrl', ['$scope', '$http', function ($scope, $http, request) {
    ...
    // Usei esta funcao para fazer o hash pedido paa consumir a api pois n'ao consegui utilizar uma lib para ficar mais simples, isto fica como um ponto para ser melhorado.
